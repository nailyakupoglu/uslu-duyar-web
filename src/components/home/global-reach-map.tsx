  ...
  return (
    <section className="section-padding bg-primary-900 text-white">
      <div className="container grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
        <div>
          <p className="text-sm font-bold uppercase tracking-[0.22em] text-accent-500">Global erişim</p>
          <h2 className="mt-5 font-display text-5xl font-semibold leading-tight text-balance">Mersin&apos;den limana, limandan hedef pazara.</h2>
