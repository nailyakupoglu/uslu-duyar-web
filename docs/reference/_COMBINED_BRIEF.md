# 🌾 EREN TARIM WEB SİTESİ — KOMPLE BRİEF PAKETİ
**Tarih:** 24 Haziran 2026
**Referans:** https://www.bennyfruit.com
...
# 📋 OPERATÖRDEN ALINACAK BİLGİLERİN LİSTESİ
**Firma:** Eren Tarım / değirmenci / biberci (Mersin)  
**Site:** bennyfruit.com benzeri, üst seviye kurumsal

Aşağıdaki sorular **tek tek cevaplanmalı**. Cevapsız bırakılan her madde Claude Code'un siteyi üretirken **placeholder** ile doldurmasına neden olur — bu da operasyonel gecikme yaratır.

---

## A) FİRMA KİMLİĞİ
1. **Firma unvanı** (tam ticari ünvan, vergi no, Mersin Ticaret Sicil no)
2. **Kuruluş yılı**
3. **Marka adı / Logo** (PNG veya SVG)
4. **Hukuki yapı** (Ltd. Şti. / A.Ş. / Şahıs?)
5. **Sahip/yönetim** (fotoğraflarıyla birlikte)
6. **Çalışan sayısı**
7. **Bayi/şube var mı?** Kaç tane, nerede?
8. **Vergi dairesi** ve **Mersin adres** (açık adres + Google Maps linki)
9. **Telefon, WhatsApp Business, e-posta** (genel + satış + ihracat ayrı)
10. **Instagram, Facebook, LinkedIn, YouTube, TikTok** (varsa linkleri)
11. **Web sitesi alan adı** (varsa mevcut site, istenen yeni alan adı)
12. **Marka sloganı** (varsa — yoksa önerilecek)
13. **Rakip firmalar** (en önemli 3-5 tanesinin adı)

---

## B) ÜRÜN PORTFÖYÜ
> Her ürün için **ayrı kart** açılacak. Aşağıdaki her satır doldurulmalı.

### B.1 — Tahıl / Un / Değirmen
14. Hangi tahıllar işleniyor? (buğday, mısır, arpa, çavdar, yulaf, nohut, mercimek…)
15. **Her biri için:** kg/ton yıllık üretim, un çeşitleri (tip 550, 650, tam buğday, ekmeklik, makarnalık…)
16. **Öğütme kapasitesi:** günde kaç ton? Tesis sayısı, markaları?
17. **Silo kapasitesi:** toplam ton, adet
18. **Ambalaj seçenekleri:** 1kg, 5kg, 25kg, 50kg, 1 ton bigbag, dökme
19. **Özel sertifikalı un var mı?** (organik, taş değirmen, glüten-free)
20. **Markalı ürünler** (perakende)? Hangi marketlerde satılıyor?

### B.2 — Biber / Baharat / Salça
21. Hangi biber çeşitleri? (kırmızı toz, pul, isot, Urfa, Acı, Tatlı, Çarliston, sivri, kapya…)
22. **Kırmızı toz biber üretimi:** yıllık ton, kurutma yöntemi (güneş/fabrika), öğütme
23. **Pul biber / isot:** ton/yıl
24. **Biber salçası:** ton/yıl, ambalaj (teneke, cam, kova, varil), özel formül
25. **Salça çeşitleri** (acı, tatlı, közleme, organik)
26. **Baharat karışımları** (köfte, kebap, çiğ köfte, mantı…)? Marka?
27. **Hammadde kaynağı:** kendi tarlası mı, sözleşmeli üretim mi, dışarıdan mı?
28. **Hasat dönemleri** (hangi ay hangi ürün?)

### B.3 — Silaj / Yem
29. Mısır silajı, yonca silajı, buğday silajı üretimi?
30. **Yıllık ton**
31. **Depolama** (hendek, tünel, şale, bunker)
32. **Müşteri:** büyükbaş/küçükbaş çiftlikler, hangi iller?

### B.4 — Diğer (varsa)
33. Zeytinyağı, bakliyat, kuruyemiş, salamura, konserve, dondurulmuş?

---

## C) ÜRETİM TESİSİ
34. **Tesis adresi** (Mersin içinde veya Tarsus, Adana?)
35. **Toplam alan (m²)** ve **kapalı alan (m²)**
36. **Kapasite:** günlük/aylık/yıllık işleme ton
37. **Makine parkı** (değirmen markaları, vals sayısı, kantar, paketleme hattı)
38. **Soğuk oda / depo** (varsa: m², °C, ton kapasite)
39. **Silo:** adet, ton, tahıl cinsi
40. **Laboratuvar** (var mı, ne test ediliyor?)
41. **Atık yönetimi / geri dönüşüm**
42. **Tesis fotoğraf & video çekimi planı** (drone onayı var mı?)

---

## D) SERTİFİKALAR & KALİTE
43. Sahip olunan sertifikalar (PDF'leri):
    - ISO 22000 / ISO 9001 / ISO 14001 / ISO 45001
    - HACCP
    - GLOBALG.A.P. / GRASP
    - BRC / IFS
    - Helal (GIMDES, TR, uluslararası)
    - Kosher
    - Organik (USDA, EU, TR)
    - FDA registration (ABD'ye ihracat için)
44. Sertifika logoları (PNG şeffaf)
45. Son denetim tarihi

---

## E) İHRACAT & PAZARLAMA
46. **İhracat yapılıyor mu?** Hangi ülkeler? (sıralı liste)
47. **Yıllık ihracat tonajı & ciro (USD, opsiyonel)**
48. **Ana müşteri tipleri:** süpermarket zinciri, distribütör, HORECA, endüstri, devlet ihaleleri
49. **Fuar katılımları:** Gulfood, SIAL, Anuga, WorldFood, Fancy Food…
50. **Fiyat politikası:** FOB Mersin, CFR, CIF, EXW?
51. **Minimum sipariş miktarı (MOQ)**
52. **Ödeme vadesi** (LC, TT, OA)
53. **Örnek müşteriler** (logolu referans mektupları, izinle)
54. **İç pazar:** Türkiye'de hangi zincirler? (Migros, BIM, A101, CarrefourSA, Metro…)
55. **E-ticaret var mı?** (Trendyol, Hepsiburada, kendi site, Getir…)

---

## F) LOJİSTİK
56. **Kendi araç filosu:** kamyon/TIR sayısı, soğutmalı/kapalı/damper
57. **Sözleşmeli nakliye firmaları**
58. **Mersin Limanı'na mesafe**
59. **Hangi limanlar kullanılıyor?** (Mersin, İskenderun, Ambarlı)
60. **İç piyasa dağıtım:** kendi araç mı, anlaşmalı?

---

## G) İÇERİK — BLOG / HABER
61. **Blog yazısı isteniyor mu?** (SEO için kritik)
62. **Var olan içerikler:** firma tarihi, ürün reçeteleri, sektör haberleri
63. **Yazar:** kim yazacak? (Claude ile üretilebilir, kontrol edilecek)

---

## H) TEKNİK TERCİHLER
64. **Alan adı** (ör. `erentanim.com.tr` veya `erentarim.com`)
65. **Hosting:** evohaus VPS (Coolify) mi, başka mı?
66. **Dil:** sadece Türkçe mi, İngilizce de ister misiniz, Arapça/Rusça?
67. **İletişim formu:** nereye mail gitsin?
68. **WhatsApp Business butonu** isteniyor mu?
69. **Canlı destek** (Crisp, Tawk.to)?
70. **Çerez / KVKK uyumu** zorunlu (TR için evet)
71. **Google Analytics 4** ve **Search Console** kurulacak mı?
72. **Meta Pixel / Google Ads tag** yönetimi

---

## I) ÖRNEK / İLHAM SİTELERİ
73. Beğenilen 3-5 kurumsal site (link ile) — Bennyfruit dışında
74. Beğenilmeyen, "kesinlikle şöyle olmasın" denilen referanslar

---

## J) BÜTÇE & ZAMAN
75. **Toplam bütçe** (TL, USD)
76. **Teslim tarihi** (ideal + en geç)
77. **Ödeme vadesi** (peşin, taksit, milestone bazlı mı?)

---

## K) GÖRSEL KAYNAKLAR
78. Mevcut fotoğraf var mı? (yüksek çözünürlük, RAW)
79. **Yeni çekim** için fotoğrafçı tutulacak mı? Bütçe?
80. **Drone çekimi** onayı
81. Stok fotoğraf kullanılabilir mi? (Unsplash, Adobe Stock)
82. **Video çekimi** (tanıtım filmi 60-90sn) isteniyor mu?

---

## L) HUKUK / YASAL
83. **Gizlilik politikası**, **Kullanım koşulları**, **Çerez politikası** metinleri hazır mı?
84. **KVKK aydınlatma metni** — operatör yazacak mı, Claude mu?
85. **Sözleşme:** kim imzalayacak? (Bennyfruit gibi 1 sayfalık "Terms" yeterli)

---

## M) ÖNCELİKLENDİRME
Aşağıdakileri **şimdi, hemen** cevaplayın (Claude Code başlamadan):
- A1, A2, A3, A9 → kimlik
- B (ürünler) → grid kartları
- C (tesis) → "üretim 4'lüsü"
- D (sertifikalar) → sertifika galerisi
- E46, E47, E48 → ihracat vurgusu
- H64, H65, H66 → domain + hosting + dil
- J75, J76 → bütçe + süre

**Diğerleri Claude Code varsayılan placeholder ile başlar, içerik geldikçe güncellenir.**
